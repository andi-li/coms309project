...
public class GameScreen extends AbstractScreen implements CutscenePlayer, CutsceneEventQueuer {
	...
	public GameScreen(DungeonExplorer app, Account account) {
		...
		worlds.put("Tutorial", WorldLoader.outdoorLevel(app.getAssetManager(), this, this, rickAnimations));
		worlds.put("Dungeon Entrance", WorldLoader.startRoom(app.getAssetManager(), this, this, rickAnimations));
