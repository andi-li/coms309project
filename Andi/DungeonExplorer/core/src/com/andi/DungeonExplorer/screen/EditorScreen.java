...
public class EditorScreen extends AbstractScreen implements CutscenePlayer, CutsceneEventQueuer {
    ...
    public EditorScreen(DungeonExplorer app, Account account) {
        ...
        worlds.put("Tutorial", worldLoader.outdoorLevel(app.getAssetManager(), this, this, null));
        worlds.put("Dungeon Entrance", worldLoader.startRoom(app.getAssetManager(), this, this, null));
        ...
        selectionScreen = new SelectionScreen(batch, index);
    ...
    public void render(float delta) {
        ...
        selectionScreen.selectBox.getScrollPane().act(delta);
