...
public class Door extends WorldObject {
	...
	public Door(int x, int y, Animation openAnimation, Animation closeAnimation, int doorId, boolean activable, int actId, CutsceneEventQueuer broadcaster) {
		super(x, y, false, (TextureRegion) openAnimation.getKeyFrames()[0], 1f, 1.5f, new GridPoint2(0,0),activable,actId,true);
	...
	public void actorInteract(Actor a) {
		if(a instanceof PlayerActor){
			...
			if(doorChecker == true ){
				...
				broadcaster.queueEvent(new ChangeWorldEvent("Dungeon Entrance", 5, 0, DIRECTION.NORTH, Color.BLACK));//add world
